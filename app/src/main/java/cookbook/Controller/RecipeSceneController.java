        ...
        /*
            public void setRecipeData(Recipe recipe, int numberOfServings) {
                ...
                // Set up the tags FlowPane based on the ObservableList of tags
                setupTagsFlowPane();
         ...
         */
            ...
            private void fetchAndInitializeTags() {
                ...
                List<String> fetchedTags = sqlRepos.getAllTags(recipe, user);

                // If recipe.getTags() is not yet initialized, initialize it here or ensure it's initialized in the Recipe constructor
                if (recipe.getTags() == null) {
                    recipe.setTags(FXCollections.observableArrayList(fetchedTags));
                } else {
                    recipe.getTags().setAll(fetchedTags); // Replace existing tags with the fetched ones
                }
                ...
                if (!tagsListenerAdded) {
                    ...
                    recipe.getTags().addListener((ListChangeListener.Change<? extends String> change) -> {
                        Platform.runLater(() -> {
                            ...
                            removedTags.forEach(this::removeTagFromPane);

                            // Update the UI for added tags
                            addedTags.forEach(this::addTagToPane);
            ...
            private void addTagToPane(String tag) {
                ...
                try {
                    ...
                    tagsFlowPane.getChildren().add(tagNode);  // Add to the FlowPane
                } catch (IOException e) {
            ...
            private void removeTagFromPane(String tag) {
            ...
            private void initializeUIFromRecipe() {
                ...
                IngredientHeadlineText.setText("Ingredients (" + recipe.getNumberOfPersons() + " servings)");
                recipeImageView.setImage(new Image(
                        recipe.getImagePath() != null ? recipe.getImagePath() : "https://images.pexels.com/photos/1109197/pexels-photo-1109197.jpeg",
                        true
                ));
